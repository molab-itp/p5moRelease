...
import { a_effectMetas } from '../let/a_effectMetas.js?v=365';
import { a_settingMetas } from '../let/a_settingMetas.js?v=365';
import { effectMeta_init } from '../core/effectMeta.js?v=365';
import { ui_capture_init } from '../core-ui/ui_capture.js?v=365';
import { ui_canvas_init } from '../core-ui/ui_canvas.js?v=365';
import { store_name_restore, store_url_parse, store_save_ent } from '../core/store_url_parse.js?v=365';
import { canvas_size_default } from '../core-ui/ui_canvas.js?v=365';
import { reset_video_clear_locals } from '../core/reset_video_clear_locals.js?v=365';
import { ui_present_window } from '../core-ui/a_ui_create.js?v=365';
// import { ui_render_size_init } from '../core-ui/ui_render.js?v=365';
//
// let effects = [
...
function setting_import(sete, index) {
  let url = './' + sete.import_path + '?v=365';
