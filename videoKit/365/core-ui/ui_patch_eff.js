...
import { ui_div_empty } from '../core-ui/ui_tools.js?v=365';
import { effectMeta_find } from '../core/effectMeta.js?v=365';
import { ui_patch_update } from '../core-ui/ui_patch_bar.js?v=365';
import { patch_remove_ipatch, patch_update_effIndex } from '../core/patch_inst.js?v=365';
import { patch_create_other } from '../core-ui/ui_patch_create.js?v=365';
