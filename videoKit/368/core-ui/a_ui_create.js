import { a_ } from '../let/a_state.js?v=368';
import { ui_canvas_div, toggleFullScreen } from '../core-ui/ui_canvas.js?v=368';
import { ui_capture_size } from '../core-ui/ui_capture.js?v=368';
import { ui_patch_bar, pad_layout_update } from '../core-ui/ui_patch_bar.js?v=368';
import { ui_div_empty, ui_div_append, ui_save_fn, ui_hide } from '../core-ui/ui_tools.js?v=368';
import { ui_patch_eff_panes } from '../core-ui/ui_patch_eff.js?v=368';
import { ui_patch_buttons } from '../core-ui/ui_patch_bar.js?v=368';
import { ui_live_selection } from '../core-ui/ui_live.js?v=368';
import { ui_chat_pane } from '../core-ui/ui_chat.js?v=368';
import { store_restore_from } from '../core/store_url_parse.js?v=368';
import { reset_video_clear_locals } from '../core/reset_video_clear_locals.js?v=368';
import { patch_instances_clear_all } from '../core/patch_inst.js?v=368';
import { ui_prop_set } from '../core-ui/ui_restore.js?v=368';
// import { ui_render_size } from '../core-ui/ui_render.js?v=368';
...
function ui_top_pane() {
  ...
  let html = `
  <button id="ipresent">Present?v=368</button>
