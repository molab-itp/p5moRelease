...
import { effectMeta_find, factory_prop_inits } from './effectMeta.js?v=370';
import { image_scaled_pad } from '../util/image.js?v=370';
import './record_video.js?v=370';
import { patch_inst_deinit } from '../core/patch_inst.js?v=370';
import { PeriodTimer } from '../util/PeriodTimer.js?v=370';
import '../core/draw.js?v=370';
