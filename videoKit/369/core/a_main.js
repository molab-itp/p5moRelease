...
import { effectMeta_find, factory_prop_inits } from './effectMeta.js?v=369';
import { image_scaled_pad } from '../util/image.js?v=369';
import './record_video.js?v=369';
import { patch_inst_deinit } from '../core/patch_inst.js?v=369';
import { PeriodTimer } from '../util/PeriodTimer.js?v=369';
import '../core/draw.js?v=369';
